...
Panel {
  ...
  // The interface is localized to Russian, so day names are taken from a
  // fixed ru_RU locale rather than the system locale. Where the week starts
  // still is: that is a regional convention rather than a translation, and
  // it stays overridable above with weekStartDay.
  readonly property var labelLocale: Qt.locale("ru_RU")
          ...
          Item {
            ...
            Row {
              ...
              Text {
                ...
                text: Qt.formatDate(root.today, Model.russianFormat(root.today, "MMMM d"))
                color: heroMouse.containsMouse
                  ? Style.hoverStateColor(root.contentForeground, Color.accent)
                  : root.contentForeground
                font.family: root.contentFontFamily
          ...
          Item {
            ...
            Item {
              ...
              Text {
                ...
                horizontalAlignment: Text.AlignHCenter
                text: Qt.formatDate(root.viewDate, Model.russianFormat(root.viewDate, "MMMM yyyy")).toUpperCase()
