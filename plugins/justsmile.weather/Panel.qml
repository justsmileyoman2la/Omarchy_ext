...
Panel {
  id: root
  moduleName: "justsmile.weather"
  ipcTarget: "justsmile.weather"
  manageIpc: false
  ...
  readonly property string reportCondition: current ? Model.currentCondition(current, "") : ""
  ...
  function dayName(dateString) {
    ...
    return Model.dayName(dateString, function(date) {
      return Qt.formatDate(date, "'" + names[date.getDay()] + "'")
    })
  }
