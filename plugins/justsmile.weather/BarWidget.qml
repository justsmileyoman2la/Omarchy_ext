...
BarWidget {
  ...
  implicitHeight: tempRow.implicitHeight
  ...
  Row {
    ...
    Text {
      visible: panelLoader.item && panelLoader.item.reportTempNum !== ""
      textFormat: Text.PlainText
      text: panelLoader.item ? panelLoader.item.reportTempNum + "°C" : ""
    ...
    Text {
      visible: panelLoader.item && panelLoader.item.reportCondition !== ""
      textFormat: Text.PlainText
      text: panelLoader.item ? panelLoader.item.reportCondition : ""
      color: root.bar.foreground
      font.family: root.bar.fontFamily
      font.pixelSize: Style.font.body
      anchors.verticalCenter: parent.verticalCenter
